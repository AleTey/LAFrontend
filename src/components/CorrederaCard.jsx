        ...
        <div className="card-body grid">
...

          {
            ...
            <abbr title="Agregar a pedidos" className="initialism">
              <button className="btn btn-success mx-1" onClick={() => onAddOrderList(corredera)}>
          ...
          {
            hasAnyRole(login.user.authorities, ["UPDATE_INPUT"]) &&
...

          {
            ...
            hasAnyRole(login.user.authorities, ["DELETE_INPUT"]) &&
