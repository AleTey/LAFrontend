...
export const ApliqueCard = ({ aplique }) => {
  ...
  const [editApliqueIsOpen, setEditApliqueIsOpen] = useState(false);
  ...
  return (
    <>
      {
        editApliqueIsOpen && selectedModal &&
        <NewInputModal
          inputToEdit={aplique}
          formIsOpen={setEditApliqueIsOpen}
        />
      }

      <div className="card g-0 mx-2 my-2" style={{ width: " 18rem" }}>
        <div className="card-body">
          <h4 className="card-title">{aplique.nombre}</h4>
          <p className="card-text">
          </p>
        </div>
        <ul className="list-group list-group-flush">
          <li className="list-group-item"><b>Id:</b> {aplique.id}</li>
          <li className="list-group-item"><b>Codigo de Fabrica:</b> {aplique.codigo}</li>
        ...
        <div className="card-body grid">
          ...
          <abbr title="Editar" className="initialism">
            <button className="btn btn-secondary mx-1" onClick={onEditAplique} >
          ...
          <abbr title="Eliminar insumo" className="initialism">
            <button className="btn btn-danger mx-1" onClick={() => onDeleteAplique(aplique.id)}>
